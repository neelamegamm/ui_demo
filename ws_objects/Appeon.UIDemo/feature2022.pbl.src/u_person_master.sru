$PBExportHeader$u_person_master.sru
forward
global type u_person_master from u_dw_master_detail
end type
type st_detail from statictext within u_person_master
end type
type uo_search from u_searchbox within u_person_master
end type
type uo_pic_custom from u_picture_tip within u_person_master
end type
type cb_save from commandbutton within u_person_master
end type
type cb_delete from commandbutton within u_person_master
end type
type cb_add from commandbutton within u_person_master
end type
end forward
...
global u_person_master u_person_master
...
type dw_detail from u_dw_master_detail`dw_detail within u_person_master
integer y = 1764
integer width = 3735
integer height = 924
string dataobject = "d_person_inherit"
end type
...
type dw_browser from u_dw_master_detail`dw_browser within u_person_master
integer y = 172
integer width = 3735
integer height = 1464
string dataobject = "d_person_list_inherit"
