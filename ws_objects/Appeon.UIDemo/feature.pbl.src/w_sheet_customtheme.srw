$PBExportHeader$w_sheet_customtheme.srw
forward
global type w_sheet_customtheme from w_sheet
end type
type uo_person from u_person within w_sheet_customtheme
end type
end forward
...
integer width = 3963
integer height = 2932
string title = "Custom Theme"
boolean controlmenu = false
string icon = ".\image\Custom_theme.ico"
boolean center = false
uo_person uo_person
end type
global w_sheet_customtheme w_sheet_customtheme

on w_sheet_customtheme.create
int iCurrent
call super::create
...
on w_sheet_customtheme.destroy
call super::destroy
