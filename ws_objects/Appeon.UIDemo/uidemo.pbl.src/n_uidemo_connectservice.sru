$PBExportHeader$n_uidemo_connectservice.sru
$PBExportComments$Generated Database Connection Service
forward
global type n_uidemo_connectservice from nonvisualobject
end type
end forward

global type n_uidemo_connectservice from nonvisualobject
end type
global n_uidemo_connectservice n_uidemo_connectservice
...
Choose Case is_connectfrom
	...
	Case IS_USE_INIFILE						/*  Populate Database Connection from INI file  */
		...
		as_dbparm		= ProfileString ( ls_inifile, "Database", "DBParm", "ConnectString='DSN=PB Demo DB V2022R2;UID=dba;PWD=sql'")
	...
	Case IS_USE_REGISTRY						/*  Populate Database Connection from Registry  */
		...
		If RegistryGet ( ls_registrykey, "DBParm", 		RegString!, as_dbparm ) <> 1 Then
			RegistrySet ( ls_registrykey, "DBParm", 		RegString!, "ConnectString='DSN=PB Demo DB V2022R2;UID=dba;PWD=sql'" )
	...
	Case IS_USE_SCRIPT							/*  Populate Database Connection from Script  */
		...
		as_logpass		= ""
		as_server		= ""
		as_dbparm		= "ConnectString='DSN=PB Demo DB V2022R2;UID=dba;PWD=sql'"
...
on n_uidemo_connectservice.create
call super::create
TriggerEvent( this, "constructor" )
end on

on n_uidemo_connectservice.destroy
